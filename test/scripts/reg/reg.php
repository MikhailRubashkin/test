 ...
 */
 ...
 if(isset($_GET['active']) and $_GET['active'] == 'ok')
	echo '<b>Ваш аккаунт на https://websb.site успешно активирован!</b>';
 ...
 if(isset($_GET['key']))
 {
	...
	else
	{
		...
		$title = 'Ваш аккаунт на https://websb.site успешно активирован';
		$message = 'Поздравляю Вас, Ваш аккаунт на https://websb.site успешно активирован';
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				$title = 'Регистрация на https://websb.site';
